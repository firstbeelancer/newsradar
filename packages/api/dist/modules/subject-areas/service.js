...
// ─── CRUD ───
export async function listSubjectAreas(workspaceId) {
...
export async function getSubjectAreaById(id) {
...
export async function updateSubjectAreaDefaults(id, data) {
