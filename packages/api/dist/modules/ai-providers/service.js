...
export async function getProviderById(id, workspaceId) {
...
export async function listProviders(workspaceId) {
...
export async function updateProvider(id, workspaceId, data) {
...
export async function deleteProvider(id, workspaceId) {
...
// ─── Test connection ───
export async function testProviderConnection(id, workspaceId) {
...
async function pingProvider(provider, baseUrl, apiKey, model) {
