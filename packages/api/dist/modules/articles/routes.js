...
import { getArticleById, listArticles, searchArticles, addToFavorite, removeFromFavorite, getArticleWithScore, } from "./service.js";
const router = Router();
// ─── Schemas ───
...
router.get("/search", authMiddleware, async (req, res, next) => {
    try {
        ...
        if (!q)
            throw new AppError(400, "q (search query) required", "VALIDATION_ERROR");
