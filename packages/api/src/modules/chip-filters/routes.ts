...
const createChipSchema = z.object({
  ...
  operator: z.enum(["contains", "not_contains", "equals", "starts_with", "regex", "in", "gt", "lt", "gte", "lte", "age_days_gt", "age_days_gte", "age_days_lt", "age_days_lte"]).default("contains"),
  scoreModifier: z.number().min(-1000).max(1000).default(0),
...
const updateChipSchema = z.object({
  ...
  operator: z.enum(["contains", "not_contains", "equals", "starts_with", "regex", "in", "gt", "lt", "gte", "lte", "age_days_gt", "age_days_gte", "age_days_lt", "age_days_lte"]).optional(),
  scoreModifier: z.number().min(-1000).max(1000).optional(),
