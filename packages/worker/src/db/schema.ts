...
export const articleScores = pgTable(
  "article_scores",
  {
    ...
    articleId: uuid("article_id")
      ...
      .notNull(),
    aiRelevance: decimal("ai_relevance", { precision: 6, scale: 2 }),
    keywordMatch: decimal("keyword_match", { precision: 6, scale: 2 }),
    freshness: decimal("freshness", { precision: 6, scale: 2 }),
    sourceTrust: decimal("source_trust", { precision: 6, scale: 2 }),
    overallScore: decimal("overall_score", { precision: 6, scale: 3 }).default("0.000").notNull(),
...
export const favoriteArticles = pgTable(
  "favorite_articles",
  {
    ...
    ttlMode: varchar("ttl_mode", { length: 10 }).default("30d").notNull(),
...
export const generatedPosts = pgTable(
  "generated_posts",
  {
    ...
    promptSnapshotJson: jsonb("prompt_snapshot_json").default({}).notNull(),
    modelSnapshotJson: jsonb("model_snapshot_json").default({}).notNull(),
